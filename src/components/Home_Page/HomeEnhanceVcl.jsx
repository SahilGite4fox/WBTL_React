...
const HomeEnhanceVcl = () => {
    return (
        <section className="enhanceVclSec commSecOverlay sv-secGap_2x col-100 floatLft clr relative">
            <div className="wrapper1500">
                <div className="enhanceVclSecCont">
                    <div className="comm_Title col-100 floatLft clr relative">
                        <h4>Enhance vehicle safety and performance </h4>
                    </div>
                    <div className="enhanceVclDisc col-100 floatLft clr relative">
                        <p>Enhance vehicle safety and performance by providing cutting-edge braking, steering, and
